...
"""test_MIPT_TC02 - Move task and verify task data is preserved"""

current_task_title = "Project organize - preserve title"
current_task_content = (
    "Verify title and content are not changed after moving project"
)


@pytest.mark.api
@pytest.mark.regression
@pytest.mark.tc_id("test_MIPT_TC02")
@pytest.mark.tc_title("Move task and verify task data is preserved")
def test_move_task_and_verify_task_data_is_preserved(api_request_context):
