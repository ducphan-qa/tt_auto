...
"""test_CWEB_TC04 - Verify API-created list project appears in web project list."""


@pytest.mark.api
@pytest.mark.regression
@pytest.mark.tc_id("test_CWEB_TC04")
@pytest.mark.tc_title("Verify API-created list project appears in web project list.")
def test_verify_api_created_project_appears_in_web_project_list(
    api_request_context,
    authenticated_page,
):
