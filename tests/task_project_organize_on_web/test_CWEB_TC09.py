...
"""test_CWEB_TC09 - Verify special-character project name appears and selects."""


@pytest.mark.api
@pytest.mark.regression
@pytest.mark.tc_id("test_CWEB_TC09")
@pytest.mark.tc_title("Verify project with special-character name appears and can be selected.")
def test_verify_special_character_project_name_selects(
    api_request_context,
    authenticated_page,
):
    ...
    project_ids = []
    task_records = []
    project_name = unique_text("PROJ WEB !@#$%^&*()")
