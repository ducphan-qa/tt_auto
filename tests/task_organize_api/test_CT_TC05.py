...
"""test_CT_TC05 - Create/Get/Delete Task With Empty Content"""

# Values
current_task_title = "Task Without Content"
current_task_content = ""


@pytest.mark.api
@pytest.mark.sanity
@pytest.mark.tc_id("test_CT_TC05")
@pytest.mark.tc_title("Create/Get/Delete Task With Empty Content")
def test_create_get_delete_task_with_empty_content(
    api_request_context,
):
