...
"""TC06 — Update Task Title With Normal Text"""

# Values
current_task_title = "Buy Milk"
current_task_content = "Buy Milk at the Vinamilk store at 7AM"

new_task_title = "Buy Milk and Coffee"


@pytest.mark.api
@pytest.mark.sanity
@pytest.mark.tc_id("test_UT_TC06")
@pytest.mark.tc_title("Update Task Title With Normal Text")
def test_create_update_get_delete_task_title_with_normal_text(api_request_context):
