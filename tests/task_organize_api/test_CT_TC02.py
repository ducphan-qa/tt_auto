...
"""test_CT_TC02 - Create/Get/Delete Task With Special Characters"""

# Values
current_task_title = "🔥Urgent_Task_#2026!"
current_task_content = "Fix API issue @ staging-server ASAP!!!"


@pytest.mark.api
@pytest.mark.sanity
@pytest.mark.tc_id("test_CT_TC02")
@pytest.mark.tc_title("Create/Get/Delete Task With Special Characters")
def test_create_get_delete_task_with_special_characters(
    api_request_context,
):
