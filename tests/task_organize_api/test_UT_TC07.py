...
"""TC07 — Update Task Content With Multi-line Text"""

# Values
current_task_title = "Buy Milk"
current_task_content = "Buy Milk at the Vinamilk store at 7AM"

new_task_content = "Buy Milk \n Buy Coffee \n Buy Apple"


@pytest.mark.api
@pytest.mark.sanity
@pytest.mark.tc_id("test_UT_TC07")
@pytest.mark.tc_title("Update Task Content With Multi-line Text")
