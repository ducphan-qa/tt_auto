...
"""test_CAPIWEB_TC03 - Verify API-generated Unicode task content on web."""


@pytest.mark.api
@pytest.mark.integration
@pytest.mark.regression
@pytest.mark.tc_id("test_CAPIWEB_TC03")
@pytest.mark.tc_title("Verify API-generated Unicode task content on web.")
def test_verify_api_generated_unicode_task_contents_on_web(
    api_request_context,
    authenticated_page,
):
    ...
    project_name = unique_text("API WEB Unicode Project")
    task_title = unique_text("API WEB Unicode") + " \u0e17\u0e14\u0e2a\u0e2d\u0e1a"
    task_content = (
        unique_text("Unicode content")
        + " \u0e2a\u0e27\u0e31\u0e2a\u0e14\u0e35 \u3053\u3093\u306b\u3061\u306f"
    )
