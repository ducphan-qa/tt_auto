...
"""test_CAPIWEB_TC02 - Verify API-generated special-character task content on web."""


@pytest.mark.api
@pytest.mark.integration
@pytest.mark.regression
@pytest.mark.tc_id("test_CAPIWEB_TC02")
@pytest.mark.tc_title("Verify API-generated special-character task content on web.")
def test_verify_api_generated_special_character_task_contents_on_web(
    api_request_context,
    authenticated_page,
):
    ...
    project_name = unique_text("API WEB Special Project")
    task_title = unique_text("API WEB Task !@#$%^&*()_+-=[]{}")
    task_content = unique_text("Symbols !@#$%^&*()_+-=[]{}|;:',.<>/?")
